...
We demonstrate with an Excel workbook containing the stoat data that is provided at https://www.otago.ac.nz/density/examples and here downloaded to the working directory:
