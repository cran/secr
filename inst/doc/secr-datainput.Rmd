...
recognised automatically as comma-delimited. Care should be taken to 
...
We demonstrate with an Excel workbook containing the stoat data that is provided at http://www.otago.ac.nz/density/examples and here downloaded to the working directory:
...
The trap locations and the detection data are in separate sheets. A capthist object is then formed in one call to `read.capthist`:
