---
title: '**secr** 2.9 - spatially explicit capture--recapture in R'
...
and incomplete detection (other sources of bias may remain). Inverse prediction (IP SECR) and maximum likelihood (ML SECR) are alternative methods for fitting the spatial detection model (Efford 2004, Borchers and Efford 2008). Of these, ML SECR is the more flexible, with a caveat for data from single-catch traps. Data augmentation and Markov chain Monte Carlo (MCMC) methods have also been used for SECR (Royle and Young 2008, Royle et al. 2009, Singh et al. 2010, Royle and Gardner 2011), but this approach is much slower than ML SECR; it is not considered here.
...
\setkeys{Gin}{height=95mm, width=130mm,keepaspectratio=TRUE}
