...
makegkPointcpp <- function(detectfn, grain, gsbval, dist2, miscparm) {
    .Call('_secr_makegkPointcpp', PACKAGE = 'secr', detectfn, grain, gsbval, dist2, miscparm)
}
...
makegkPolygoncpp <- function(detectfn, dim, convex, grain, gsbval, cumk, traps, mask) {
    .Call('_secr_makegkPolygoncpp', PACKAGE = 'secr', detectfn, dim, convex, grain, gsbval, cumk, traps, mask)
}
...
pdotpointcpp <- function(xy, traps, dist2, detect, Tsk, markocc, fn, gsb, miscparm, w2, binomN, grain) {
    .Call('_secr_pdotpointcpp', PACKAGE = 'secr', xy, traps, dist2, detect, Tsk, markocc, fn, gsb, miscparm, w2, binomN, grain)
}

hdotpolycpp <- function(xy, traps, Tsk, markocc, cumk, detectfn, gsb, convex, dim, grain) {
    .Call('_secr_hdotpolycpp', PACKAGE = 'secr', xy, traps, Tsk, markocc, cumk, detectfn, gsb, convex, dim, grain)
}
...
fasthistoriescpp <- function(mm, nc, cc, grain, binomN, indiv, w, ki, gk, hk, density, PIA, Tsk, mbool) {
    .Call('_secr_fasthistoriescpp', PACKAGE = 'secr', mm, nc, cc, grain, binomN, indiv, w, ki, gk, hk, density, PIA, Tsk, mbool)
}

polygonhistoriescpp <- function(nc, detectfn, grain, minp, binomN, w, xy, start, group, hk, H, gsbval, pID, mask, density, PIA, Tsk, h, hindex, mbool) {
    .Call('_secr_polygonhistoriescpp', PACKAGE = 'secr', nc, detectfn, grain, minp, binomN, w, xy, start, group, hk, H, gsbval, pID, mask, density, PIA, Tsk, h, hindex, mbool)
}

polygonfxicpp <- function(nc, detectfn, grain, minp, binomN, w, xy, start, group, hk, H, gsbval, pID, mask, density, PIA, Tsk, h, hindex, mbool) {
    .Call('_secr_polygonfxicpp', PACKAGE = 'secr', nc, detectfn, grain, minp, binomN, w, xy, start, group, hk, H, gsbval, pID, mask, density, PIA, Tsk, h, hindex, mbool)
}

signalhistoriescpp <- function(mm, nc, detectfn, grain, binomN, w, signal, group, gk, gsbval, dist2, density, PIA, miscparm, mbool) {
    .Call('_secr_signalhistoriescpp', PACKAGE = 'secr', mm, nc, detectfn, grain, binomN, w, signal, group, gk, gsbval, dist2, density, PIA, miscparm, mbool)
}
...
simplehistoriesfxicpp <- function(x, mm, nc, cc, grain, binomN, w, group, gk, hk, density, PIA, Tsk, h, hindex) {
    .Call('_secr_simplehistoriesfxicpp', PACKAGE = 'secr', x, mm, nc, cc, grain, binomN, w, group, gk, hk, density, PIA, Tsk, h, hindex)
}
