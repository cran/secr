...
hdotpolycpp2 <- function(xy, traps, Tsk, markocc, cumk, detectfn, gsb, convex, dim, grain) {
    .Call('_secr_hdotpolycpp2', PACKAGE = 'secr', xy, traps, Tsk, markocc, cumk, detectfn, gsb, convex, dim, grain)
}
