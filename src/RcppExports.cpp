...
// naivecap2cpp
double naivecap2cpp(const int detect, const int binomN, const double g0, const double sigma, int ss, const IntegerVector& wt, const NumericMatrix& traps, const NumericMatrix& mask, const int fn);
RcppExport SEXP _secr_naivecap2cpp(SEXP detectSEXP, SEXP binomNSEXP, SEXP g0SEXP, SEXP sigmaSEXP, SEXP ssSEXP, SEXP wtSEXP, SEXP trapsSEXP, SEXP maskSEXP, SEXP fnSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const int >::type fn(fnSEXP);
    rcpp_result_gen = Rcpp::wrap(naivecap2cpp(detect, binomN, g0, sigma, ss, wt, traps, mask, fn));
    return rcpp_result_gen;
END_RCPP
}
// getdenomcpp
List getdenomcpp(int fn, NumericVector miscparm, NumericMatrix mask, int mm, double sigma, double z);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type miscparm(miscparmSEXP);
...
// makegkParallelcpp
List makegkParallelcpp(const int detectfn, const int grain, const NumericMatrix& gsbval, const NumericMatrix& dist2, const NumericVector& miscparm);
RcppExport SEXP _secr_makegkParallelcpp(SEXP detectfnSEXP, SEXP grainSEXP, SEXP gsbvalSEXP, SEXP dist2SEXP, SEXP miscparmSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(makegkParallelcpp(detectfn, grain, gsbval, dist2, miscparm));
    return rcpp_result_gen;
END_RCPP
}
// cappedgkhkcpp
...
// makegkpolygoncpp
List makegkpolygoncpp(const int detectfn, const int dim, const int grain, const NumericMatrix& gsbval, const IntegerVector& cumk, const NumericMatrix& traps, const NumericMatrix& mask);
RcppExport SEXP _secr_makegkpolygoncpp(SEXP detectfnSEXP, SEXP dimSEXP, SEXP grainSEXP, SEXP gsbvalSEXP, SEXP cumkSEXP, SEXP trapsSEXP, SEXP maskSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const int >::type detectfn(detectfnSEXP);
    ...
    Rcpp::traits::input_parameter< const NumericMatrix& >::type traps(trapsSEXP);
    Rcpp::traits::input_parameter< const NumericMatrix& >::type mask(maskSEXP);
    rcpp_result_gen = Rcpp::wrap(makegkpolygoncpp(detectfn, dim, grain, gsbval, cumk, traps, mask));
    return rcpp_result_gen;
END_RCPP
}
// makelookupcpp
...
// hdotpolycpp
NumericVector hdotpolycpp(const NumericMatrix xy, const NumericMatrix traps, const IntegerVector detect, const NumericMatrix Tsk, const IntegerVector markocc, const int nk, const int ss, const IntegerVector kk, const int fn, const NumericVector gsb);
RcppExport SEXP _secr_hdotpolycpp(SEXP xySEXP, SEXP trapsSEXP, SEXP detectSEXP, SEXP TskSEXP, SEXP markoccSEXP, SEXP nkSEXP, SEXP ssSEXP, SEXP kkSEXP, SEXP fnSEXP, SEXP gsbSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericMatrix >::type xy(xySEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type fn(fnSEXP);
    Rcpp::traits::input_parameter< const NumericVector >::type gsb(gsbSEXP);
    rcpp_result_gen = Rcpp::wrap(hdotpolycpp(xy, traps, detect, Tsk, markocc, nk, ss, kk, fn, gsb));
    return rcpp_result_gen;
END_RCPP
}
// ontransectcpp
...
// fasthistoriescpp
NumericVector fasthistoriescpp(const int mm, const int nc, const int cc, const int grain, const int binomN, const IntegerMatrix w, const IntegerMatrix ki, const NumericVector gk, const NumericVector hk, const NumericVector density, const IntegerVector PIA, const IntegerVector Tsk, const LogicalMatrix mbool);
RcppExport SEXP _secr_fasthistoriescpp(SEXP mmSEXP, SEXP ncSEXP, SEXP ccSEXP, SEXP grainSEXP, SEXP binomNSEXP, SEXP wSEXP, SEXP kiSEXP, SEXP gkSEXP, SEXP hkSEXP, SEXP densitySEXP, SEXP PIASEXP, SEXP TskSEXP, SEXP mboolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(fasthistoriescpp(mm, nc, cc, grain, binomN, w, ki, gk, hk, density, PIA, Tsk, mbool));
    return rcpp_result_gen;
END_RCPP
}
// polygonhistoriescpp
NumericVector polygonhistoriescpp(const int x, const int nc, const int detectfn, const int grain, const double minp, const IntegerVector binomN, const IntegerVector w, const NumericMatrix xy, const IntegerVector start, const IntegerVector group, const NumericVector hk, const NumericVector H, const NumericMatrix gsbval, const NumericMatrix pID, const NumericMatrix mask, const NumericMatrix density, const IntegerVector PIA, const NumericMatrix Tsk, const NumericMatrix h, const IntegerMatrix hindex, const LogicalMatrix mbool);
RcppExport SEXP _secr_polygonhistoriescpp(SEXP xSEXP, SEXP ncSEXP, SEXP detectfnSEXP, SEXP grainSEXP, SEXP minpSEXP, SEXP binomNSEXP, SEXP wSEXP, SEXP xySEXP, SEXP startSEXP, SEXP groupSEXP, SEXP hkSEXP, SEXP HSEXP, SEXP gsbvalSEXP, SEXP pIDSEXP, SEXP maskSEXP, SEXP densitySEXP, SEXP PIASEXP, SEXP TskSEXP, SEXP hSEXP, SEXP hindexSEXP, SEXP mboolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const LogicalMatrix >::type mbool(mboolSEXP);
    rcpp_result_gen = Rcpp::wrap(polygonhistoriescpp(x, nc, detectfn, grain, minp, binomN, w, xy, start, group, hk, H, gsbval, pID, mask, density, PIA, Tsk, h, hindex, mbool));
    return rcpp_result_gen;
END_RCPP
}
// signalhistoriescpp
NumericVector signalhistoriescpp(const int x, const int mm, const int nc, const int detectfn, const int grain, const IntegerVector binomN, const IntegerVector w, const NumericMatrix signal, const IntegerVector group, const NumericVector gk, const NumericMatrix gsbval, const NumericMatrix dist2, const NumericMatrix density, const IntegerVector PIA, const NumericVector miscparm, const LogicalMatrix mbool);
RcppExport SEXP _secr_signalhistoriescpp(SEXP xSEXP, SEXP mmSEXP, SEXP ncSEXP, SEXP detectfnSEXP, SEXP grainSEXP, SEXP binomNSEXP, SEXP wSEXP, SEXP signalSEXP, SEXP groupSEXP, SEXP gkSEXP, SEXP gsbvalSEXP, SEXP dist2SEXP, SEXP densitySEXP, SEXP PIASEXP, SEXP miscparmSEXP, SEXP mboolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const int >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< const NumericVector >::type miscparm(miscparmSEXP);
    Rcpp::traits::input_parameter< const LogicalMatrix >::type mbool(mboolSEXP);
    rcpp_result_gen = Rcpp::wrap(signalhistoriescpp(x, mm, nc, detectfn, grain, binomN, w, signal, group, gk, gsbval, dist2, density, PIA, miscparm, mbool));
    return rcpp_result_gen;
END_RCPP
}
// gethr
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(simplehistoriescpp(mm, nc, cc, grain, binomN, markocc, firstocc, pID, w, group, gk, hk, density, PIA, Tsk, h, hindex, mbool, telemhr, telemstart));
    return rcpp_result_gen;
END_RCPP
}
...
// Tsightinglikcpp
List Tsightinglikcpp(const IntegerMatrix& T, const IntegerVector& markocc, const IntegerVector& binomN, const NumericMatrix& Tsk, const NumericMatrix& musk, const int debug);
...
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const IntegerMatrix& >::type T(TSEXP);
    Rcpp::traits::input_parameter< const IntegerVector& >::type markocc(markoccSEXP);
    Rcpp::traits::input_parameter< const IntegerVector& >::type binomN(binomNSEXP);
    Rcpp::traits::input_parameter< const NumericMatrix& >::type Tsk(TskSEXP);
    Rcpp::traits::input_parameter< const NumericMatrix& >::type musk(muskSEXP);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sightingchatcpp(mm, nc, cc0, grain, nsim, sightmodel, sumD, area, distrib, binomN, markocc, pID, group, gk0, hk0, density, PIA0, Tsk, pmix));
    return rcpp_result_gen;
END_RCPP
}
// expectedmucpp
List expectedmucpp(const int x, const int mm, const int nc, const int cc, const int Tu, const int Tm, const int sightmodel, const IntegerVector binomN, const IntegerVector markocc, const NumericVector pID, const IntegerVector group, const NumericVector gk, const NumericVector hk, const NumericMatrix pi_density, const NumericMatrix Nm, const IntegerVector PIA, const NumericMatrix Tsk, const NumericMatrix h, const IntegerMatrix hindex, const NumericVector a0);
RcppExport SEXP _secr_expectedmucpp(SEXP xSEXP, SEXP mmSEXP, SEXP ncSEXP, SEXP ccSEXP, SEXP TuSEXP, SEXP TmSEXP, SEXP sightmodelSEXP, SEXP binomNSEXP, SEXP markoccSEXP, SEXP pIDSEXP, SEXP groupSEXP, SEXP gkSEXP, SEXP hkSEXP, SEXP pi_densitySEXP, SEXP NmSEXP, SEXP PIASEXP, SEXP TskSEXP, SEXP hSEXP, SEXP hindexSEXP, SEXP a0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const int >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type nc(ncSEXP);
    Rcpp::traits::input_parameter< const int >::type cc(ccSEXP);
    Rcpp::traits::input_parameter< const int >::type Tu(TuSEXP);
    Rcpp::traits::input_parameter< const int >::type Tm(TmSEXP);
    Rcpp::traits::input_parameter< const int >::type sightmodel(sightmodelSEXP);
    Rcpp::traits::input_parameter< const IntegerVector >::type binomN(binomNSEXP);
    Rcpp::traits::input_parameter< const IntegerVector >::type markocc(markoccSEXP);
    Rcpp::traits::input_parameter< const NumericVector >::type pID(pIDSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(expectedmucpp(x, mm, nc, cc, Tu, Tm, sightmodel, binomN, markocc, pID, group, gk, hk, pi_density, Nm, PIA, Tsk, h, hindex, a0));
    return rcpp_result_gen;
END_RCPP
}
// simdetectpointcpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_secr_naivecap2cpp", (DL_FUNC) &_secr_naivecap2cpp, 9},
    {"_secr_getdenomcpp", (DL_FUNC) &_secr_getdenomcpp, 6},
    {"_secr_gethcpp", (DL_FUNC) &_secr_gethcpp, 9},
    {"_secr_makegkParallelcpp", (DL_FUNC) &_secr_makegkParallelcpp, 5},
    {"_secr_cappedgkhkcpp", (DL_FUNC) &_secr_cappedgkhkcpp, 6},
    {"_secr_makegkpolygoncpp", (DL_FUNC) &_secr_makegkpolygoncpp, 7},
    ...
    {"_secr_fasthistoriescpp", (DL_FUNC) &_secr_fasthistoriescpp, 13},
